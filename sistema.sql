...
-- Crear la tabla 'cliente' con los nuevos campos
CREATE TABLE `cliente` (
  ...
  `imagen` varchar(100) COLLATE utf8_spanish_ci,
  `grupo_sangre` varchar(10) COLLATE utf8_spanish_ci,
...
(1, 'Ana', 'Lopez', '123456789', '978645132', 'Perú', 'Trujillo', 'foto1.jpg', 'A+'),
(2, 'Maria', 'Sanchez', '987654321', '974561234', 'Perú', 'Trujillo', 'foto2.jpg', 'B-'),
...
CREATE TABLE Pais (
  ...
  prefijo_telefonico VARCHAR(10),
  cctld VARCHAR(10)
);

-- Volcado de datos para la tabla `pais`
--
INSERT INTO Pais (id, nombre, capital, idioma_oficial, moneda, poblacion, area, continente, codigo_pais, prefijo_telefonico, cctld)
VALUES
