...
<h3 class="text-center">DATOS ACADÉMICOS O PROFESIONALES</h3>
<div class="card">
    <div class="card-body">
        <div class="row">
            <div class="col-md-12">
            ...
            <table class="table table-bordered table-primary">
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <th><span class="text-primary">Institucion</span></th>
                            <th><span class="text-success">Nivel academico</span></th>
                            <th><span class="text-danger">Modalidad</span></th>
                            <th><span class="text-warning">Titulo</span></th>
                            <th><span class="text-info">Inicio</span></th>
                            <th><span class="text-success">Finalizacion</span></th>
                            <th><span class="text-primary">Imagen</span></th>                            
